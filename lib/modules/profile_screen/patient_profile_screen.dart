...
class PatientProfileScreen extends StatelessWidget {
  const PatientProfileScreen({Key? key, this.reciever, this.uID})
      : super(key: key);
  final reciever;
                          ...
                          Expanded(
                              child: OutlinedButton(
                                  onPressed: () {
                                    ...
                                    cubit.isFollowing
                                        ? {cubit.followMethod(
                                        doctorUserUid: FirebaseAuth
                                            .instance.currentUser?.uid,
                                        patientUid: uID,
                                        patName: reciever.userName,
                                        docName:
                                        DoctorCubit.get(context).doctorUserModel!
                                            .userName,)
