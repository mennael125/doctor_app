...
class SettingScreenDoctor extends StatelessWidget {
  const SettingScreenDoctor({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DoctorCubit, DoctorStates>(
      ...
      builder: (cubit, state) {
        ...
        var docModel = cubit.doctorUserModel;
        CollectionReference postRef =
            FirebaseFirestore.instance.collection('post');
        var postsList = DoctorCubit.get(context).postsList;
       // var PostId = DoctorCubit.get(context).postId;

        // var PostCommentId = DoctorCubit.get(context).postCommentId;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: NetworkImage('${docModel.cover}'),
                                      // image: NetworkImage(
                          ...
                          onTap: () {
                            navigateTo(
                              ...
                              widget: LocationInfoScreen(
                                  location: docModel.clinicLocation),
                            );
                          },
                          child: Column(
                            children: [
                      ...
                      children: [
                                ...
                                onPressed: () {
                                  navigateTo(
                                    widget: DocFullInfoScreen(
                                      name: docModel.userName,
                                      clinicLocation: docModel.clinicLocation,
                                      specialization: docModel.specialization,
                                      scientificDegree:
                                          docModel.scientificDegree,
                                      email: docModel.email,
                                      country: docModel.country,
                                      gender: docModel.gender,
                                    ),
                                    context: context,
                                  );
                                },
                        ...
                        OutlinedButton(
                            onPressed: () {
                              navigateTo(
                                  context: context,
                                  widget: const EditProfileScreenDoctor());
                            },
                        ...
                        widgetBuilder: (BuildContext context) {
                          return SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                StreamBuilder(
                                    stream: postRef.where('uID',
                                        isEqualTo: FirebaseAuth
                                            .instance.currentUser?.uid).snapshots(),
                ...
                CircleAvatar(
                  ...
                  child: CircleAvatar(
                    backgroundImage: NetworkImage(
                      ...
                      DoctorCubit.get(context).doctorUserModel!.image! ,
                    ),
                    radius: 25,
                  ),
                ),
                ...
                Expanded(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          DoctorCubit.get(context).doctorUserModel!.userName! ,
                          style: Theme.of(context)
                              .textTheme
                              .bodyText1!
                              .copyWith(height: 1.4),
