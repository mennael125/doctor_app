...
//function to get current position
  Future getPosition() async {
    ...
    if (services == false) {
      ...
      Center(
        child: Text("Your location is off please turn on it"),
      );
    }
            ...
            : Column(
                children: [
                  ...
                  Container(
                    ...
                    child: GoogleMap(
                      onTap: (LatLang) {
                        //to remove marker from position and put it in position you pressed on
                        myMarker.remove(Marker(
                          markerId: MarkerId("1"),
                        ));
                        myMarker.add(
                            Marker(markerId: MarkerId("1"), position: LatLang));
                        setState(() {});
                      },
                      markers: myMarker,
